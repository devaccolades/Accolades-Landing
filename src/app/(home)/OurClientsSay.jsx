...
//         modules={[Pagination]}
//         pagination={{ type: 'progressbar', el: '.swiper-progressbar' }}
//       >
...
const WhatOurClientsSay = () => {
  ...
  return (
    <section className=" ml-0 md:ml-20 mx-auto px-4 py-16">
      <div className="text-center mb-6">
        <div className="flex items-center justify-center gap-2 mb-2">
          <Image src="/images/sidebar.png" alt="sidebar" width={63} height={63} />
          <p className="text-sm font-medium text-gray-600">Why Accolades</p>
      ...
      {/* <div className="max-w-2xl mx-auto mt-[200px]">
        <div className="swiper-pagination swiper-pagination-progressbar h-1 bg-gray-200 rounded-full overflow-hidden">
          <div className="swiper-pagination-progressbar-fill bg-teal-600 h-1"></div>
        </div>
      </div> */}
