  ...
  return (
    <section className="relative overflow-hidden font-mont mt-18 md:mt-25 lg:mt-28 rounded-[20px] mx-2  my-2">
      ...
      {/* <div className="absolute inset-0 z-20 flex items-center justify-center drop-shadow-[0_0_140px_rgba(0,255,255,0.35)]">
        <div className="relative w-[180px] h-[180px] md:w-[220px] md:h-[220px] drop-shadow-[0_0_122px_rgba(0,255,255,0.35)]">
          <Image
            // src="/ai-by/bg3.png"
            src="/ai-by/ai.svg"
            alt="AI Core"
       ...
       <div className="absolute inset-0 z-20 flex items-center justify-center drop-shadow-[0_0_140px_rgba(0,255,255,0.35)]">
      <motion.div
        className="relative w-[180px] h-[180px] md:w-[220px] md:h-[220px] drop-shadow-[0_0_122px_rgba(0,255,255,0.35)]"
        animate={{
          x: [0, 1, -1, 1, -1, 0],
          y: [0, -1, 1, -1, 1, 0],
        }}
      ...
      {/* CONTENT */}
       <div className="relative z-30 mx-auto flex min-h-screen  items-start px-2 md:px-6 pt-8 ">
