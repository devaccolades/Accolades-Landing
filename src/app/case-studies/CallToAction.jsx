        ...
        <section className="font-mont w-[90%] lg:w-[80%] mx-auto py-10 flex justify-center">
            <div className="text-center px-4">
                ...
                <h2 className="text-[36px] md:text-[48px] lg:text-[64px] leading-[100%] font-semibold mb-8">
                    Want Similar Results <br className="hidden sm:block" /> for Your Brand?
                </h2>

                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <a className='relative w-auto h-fit flex justify-center items-center' href="https://wa.me/919048100233"
                        target="_blank"
                        ...
                        />
                        <p className='absolute left-12 text-[16px] font-bold leading-[100%] tracking-wider text-white'>
                            +91 90481 00233
                        </p>
                    </a>
                    ...
                    <a
                        ...
                        className="flex items-center gap-2 border border-gray-300 px-6 py-3 rounded-lg text-sm font-medium hover:bg-gray-50 transition"
                    >
                        <Image
                            src={mail}
                            alt="Email"
