    ...
    <>
      <section className="container mx-auto px-4 py-8 bg-white rounded-2xl shadow-xl my-10">
        ...
        <p className="text-center text-gray-600 text-md mx-auto  mb-10">
          Lorem ipsum dolor sit amet consectetur. Ipsum turpis sem tristique ut
          amet mauris ut. Nulla proin nisi consectetur amet semper lacus. Sit
          vestibulum sit nisi justo augue nam tristique. Nunc sapien ac.
        </p>
      </section>
