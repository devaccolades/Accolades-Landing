...
function HeroSection() {
  return (
    <section className="h-[400px] md:h-[400px] w-full pt-20 md:pt-24 lg:pt-30">
      <div className="flex flex-col items-center justify-center bg-white w-[90%] mx-auto p-4 rounded-2xl relative z-10">
        <h1 className="font-monst text-[36px] md:text-[50px] lg:text-[64px] font-bold leading-[130%] text-[#3FB4BA]">
