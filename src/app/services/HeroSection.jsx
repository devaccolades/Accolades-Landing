...
function HeroSection() {
  return (
    <section className="h-[60vh] w-full">
      <div className="flex flex-col items-center justify-center bg-gray-500 w-[80%] mx-auto p-4 rounded-lg">
        <h1 className="font-monst text-[86px] font-bold leading-[130%] text-[#3FB4BA]">
          Services
        </h1>
        <p className="max-w-6xl text-center mt-[30px]">
