      ...
      <div className="containers">
        <div className="w-full">
          <div className="bg-white rounded-[30px] px-6 md:px-8 lg:px-10 py-6 md:py-8 lg:py-10 mt-6 space-y-2">
            <p className="font-mont text-[16px] lg:text-[20px] leading-[110%] font-normal text-[#333333] uppercase">
              SEO That Drives Results
            </p>

            <h2 className="font-mont font-bold text-[24px] lg:text-[36px] leading-[100%] text-[#3FB4BA] ">
              Enhance visibility and attract traffic
            </h2>

            <div className="font-mont font-normal text-[13px] md:text-[14px] xl:text-[18px] leading-[156%]  text-[#000000] space-y-4">
              <p>
