...
export default function Process() {
  return (
    <section className="lg:pb-12 md:pb-10 pb-8 ">
      <div className="containers text-center">
        <h2 className="font-mont font-bold xl:text-[40px] lg:text-[34px] md:text-[28px] text-[22px] leading-[130%] text-[#3FB4BA] mb-4 ">
          Our SEO Process
        </h2>
