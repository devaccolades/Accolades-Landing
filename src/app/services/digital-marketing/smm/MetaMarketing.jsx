...
//           {/* Heading */}
//           <h2 className="text-[24px] xl:text-[32px] font-bold text-black leading-[24px] lg:leading-[34px]">
//             META (FACEBOOK & <br />
//             INSTAGRAM) MARKETING
//           </h2>

//           {/* Description */}
//           <p className="text-black font-semibold text-[13px] md:text-[16px] leading-[156%] max-w-xl">
...
//               <div className="w-9 xl:w-10  h-9 xl:h-10 flex-shrink-0 overflow-hidden">
//                 <Image
...
//               </div>
//               <div>
//                 <h4 className="text-[16px] xl:text-[18px] leading-[14px] xl:leading-[16px] font-semibold text-black mb-1">
//                   Advanced AI Targeting
//                 </h4>
//                 <p className=" text-black text-[13px] xl:text-[14px] leading-[120%] xl:leading-[156%]">
...
//                   Optimized for Sales
//                 </h4>
//                 <p className="text-[13px] xl:text-[14px] leading-[120%] xl:leading-[156%] text-black ">
