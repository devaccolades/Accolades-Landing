...
//           <h1 className="text-[#3FB4BA] font-mont font-bold text-center leading-[130%] mb-4
...
//             <p className="uppercase text-xs sm:text-sm text-gray-500 font-mont font-semibold mb-2">
//               Development
//             </p>
//             <h2 className="text-[20px] lg:text-[26px] leading-[130%] font-bold font-mont text-[#1eb2a6] mb-4">
//               Web Development
//             </h2>
//             <p className="text-gray-700 font-mont text-[12px] lg:text-[14px]   leading-[130%]">
  ...
  return (
    <div className="min-h-screen py-12 px-4 md:px-10 lg:px-20">
      <div className="mx-auto max-w-7xl">
        {/* Header */}
        <div className="bg-white rounded-[30px] py-6 px-4">
          <h1 className="text-[#3FB4BA] font-mont font-bold text-center leading-[130%] mb-4 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[70px]">
            Web Development
          </h1>
        </div>

        {/* Content Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10 mt-10 items-center">
          ...
          <div className="bg-white rounded-2xl shadow-md p-2 md:p-4 order-2 lg:order-1">
            <p className="uppercase text-xs sm:text-sm text-gray-500 font-mont font-semibold mb-2">
              Development
            </p>
            <h2 className="text-[20px] lg:text-[26px] leading-[130%] font-bold font-mont text-[#1eb2a6] mb-4">
