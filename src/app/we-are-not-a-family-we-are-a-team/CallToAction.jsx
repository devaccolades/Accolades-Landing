        ...
        <section className="font-mont bg-white py-8 lg:py-16 w-[90%] lg:w-[80%] mx-auto flex items-center justify-center">
            <div className="text-center max-w-3xl px-4">
                ...
                <Link href="/contact-us">
                    <button className="mt-8 inline-flex items-center gap-2 bg-[#0C7379] cursor-pointer hover:bg-[#0C7879] text-white font-medium px-6 py-3 rounded-full transition">
                        Start a Project
