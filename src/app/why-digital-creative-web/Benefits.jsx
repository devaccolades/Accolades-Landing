...
export default function Benefits() {
    return (
        <div className='bg-[#F9F9F9] rounded-[30px] py-8 md:py-12 lg:py-16'>
            <div className='containers'>
                <div className='flex flex-col justify-center items-center'>
                    <h1 className='font-urbanist font-bold text-[16px] md:text-[18px] lg:text-[20px] leading-[16px] text-[#000000] mb-2 md:mb-4'>CORE BENEFITS</h1>
                    <p className='font-urbanist font-semibold lg:text-[16px] text-[13px] md:text-[14px] text-[#000000] mb-2 md:mb-4 w-[75%] md:text-center'>Integration isn't just theory. Here's what it means for your business.</p>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 lg:gap-3">
                    ...
                    <div className="rounded-xl p-3 md:p-4 lg:p-5 border border-[#FF6400]/60 bg-[linear-gradient(104.85deg,_#FFF6EC_0.74%,_#FFEDD5_97.47%)] ">
                        ...
                        <h3 className="font-urbanist font-semibold xl:text-[24px] lg:text-[20px] md:text-[18px] text-[15px] xl:leading-[24px] lg:leading-[20px] md:leading-[18px] leading-[16px] mb-1 md:mb-2 text-[#000000]">
                            One Strategy
                        </h3>
                    ...
                    {/* Creative */}
                    <div className="rounded-xl p-2 md:p-4 lg:p-5 bg-[linear-gradient(104.76deg,_#EFFDF9_0.98%,_#CCFBF1_97.9%)] border border-[#00B4A1]/60 ">
                    ...
                    {/* Web */}
                    <div className="rounded-xl p-3  lg:p-5 bg-[linear-gradient(104.52deg,_#F9F4FF_0.97%,_#F3E8FF_99.27%)] border border-[#AA41FF]/60">
