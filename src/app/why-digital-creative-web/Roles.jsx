...
export default function Roles() {
    return (
        <section className="relative w-full pb-12 md:pb-16 -mt-4 md:-mt-6 lg:-mt-8 xl:-mt-10">
            <div className="containers">
                ...
                <div className="flex flex-col items-center text-center px-4 py-12 w-full">
                    ...
                    <p className="font-poppins font-normal text-[12px] leading-[156%] text-[#484848] mb-6">
