...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="sticky top-10 containers z-50">
        <GlassSurface
          width={"100%"}
          height={59}
          borderRadius={50}
        ...
        >
          <Image
            ...
            width={100}
            priority
            className="w-[205px] h-[38px] cursor-pointer"
          />
          ...
          <button className="bg-[#0C7379] py-[10px] px-[16px] text-white rounded-[10px] text-[16px] font-bold leading-[100%] cursor-pointer">
            WhatsApp now
          </button>
        </GlassSurface>
      </nav>
